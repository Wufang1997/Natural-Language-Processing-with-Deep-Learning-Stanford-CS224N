...
def pad_sents_char(sents, char_pad_token):
    ...
    output = []
    for s in sents:
        sent_padded = [[char_pad_token] * max_word_length for i in range(max_sent_length)]
        for i, charid in enumerate(s):
            char_padded = [char_pad_token] * max_word_length
            char_padded[:len(charid)] = charid
            sent_padded[i] = char_padded
        output.append(sent_padded)
