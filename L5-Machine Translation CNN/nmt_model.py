...
class NMT(nn.Module):
    ...
    def forward(self, source: List[List[str]], target: List[List[str]]) -> torch.Tensor:
        ...
        """
        Note: It's right now the "to_input_tensor_char" instead of "to_input_tensor".
        """
        ...
        if self.charDecoder is not None:
            ...
            """ 
            there is something bug in the original code without "contiguous()" function,
            but I still don't understand why this works, since the length of target_padded_chars[1:] is changed.
            """
